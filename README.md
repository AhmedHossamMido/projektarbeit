...
Dieses Repository enthält eine gemeinsame Jupyter-Notebook-Datei (`projektdatei.ipynb`). Für eine reibungslose Zusammenarbeit gelten folgende verbindliche Regeln:
